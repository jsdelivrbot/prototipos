	...
	render(){
		...
		return(
			...
			<div style={ style_inner_footer }>
				<div>Healthy food for all Angelenos</div>
				<br />
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/about">About</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/resources">Resources</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/about">Other 3</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/resources">Other 4</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/about">Other 5</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/resources">Other 6</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/about">Other 7</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/resources">Other 8</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/about">Other 9</Link></div>
				<div onClick={ window.scroll(0,0) } style={ style_list }><Link style={ style_anchors } to="/resources">Other 10</Link></div>
				...
				{/* <section id="donate">
					...
					<p className="action"><a href="https://www.codeforamerica.org/donate" target="_blank">Donate</a></p>
				</section>
			...
			<p className="join"></p><p>Join us at <a href="https://www.meetup.com/hackforla/">Hack for LA</a>, Tuesdays at 6pm</p>
	<p></p>
			<p className="action"><a href="mailto:contact@foodoasis.la">Send us a message</a></p>
			<div>
				...
				<a href="https://github.com/foodoasisla">
		...
		<section>
			<p>This is an <a href="https://github.com/foodoasisla/site/blob/master/LICENSE">open source</a> project.</p>
			<p>You can download or <a href="https://github.com/foodoasisla/site/issues">contribute</a> to the code on <a href="https://github.com/foodoasisla/site">GitHub</a>.</p>
		</section>
	
	
		<section>
			<p>FOLA is in beta. <a href="/beta">Find out more about this</a>.</p> 
		</section>
		*/}
